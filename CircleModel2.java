...
public class CircleModel2 implements CircleEvents {
	...
	public void setRadius(double radius) {
		...
		processEvent(eventType.RADIUS,
				new MyActionEvent(this, eventType.RADIUS.ordinal(), eventType.RADIUS.toString()));
	}
	...
	public void setFilled(Boolean filled) {
		...
		processEvent(eventType.FILLED,
				new MyActionEvent(this, eventType.FILLED.ordinal(), eventType.FILLED.toString()));
	}
